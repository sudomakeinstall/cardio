        ...
        #            )
            ...
            with layout.content:
                with vuetify.VContainer(
                    ...
                    view = vtk_widgets.VtkRemoteView(self.scene.renderWindow, interactive_ratio=1)
            ...
            with layout.drawer:
                ...
                with vuetify.VBtn(icon=True, click=self.server.controller.decrement_frame, title="Previous"):
                    vuetify.VIcon("mdi-skip-previous-circle")
        
                with vuetify.VBtn(icon=True, click=self.server.controller.increment_frame, title="Next"):
